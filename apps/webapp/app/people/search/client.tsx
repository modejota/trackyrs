...
import { useInfinitePeopleSearch } from "@/app/api/people/queries";
...
function PeopleCard({
	...
	person: { id: number; name: string; images: string };
}) {
	return (
		<Link
...
export default function PeopleSearchClient() {
	...
	const allPeople = useMemo(
		() => data?.pages.flatMap((p: { people: any[] }) => p.people) ?? [],
		[data],
	);
					...
					{isLoading ? null : isError ? (
						...
						<div className="py-12 text-center">
							<div className="mx-auto max-w-md">
								...
								<p className="text-muted-foreground text-sm">
									No results match your search. Try different keywords or clear
									the search.
								</p>
								<div className="mt-4">
						...
						<div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
							...
							{isFetchingNextPage &&
								generateArray(
									"loading-next-people-search-cards",
									placeholderCount,
